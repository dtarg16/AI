...
class InferenceModule:
    ...
    def getObservationProb(self, noisyDistance, pacmanPosition, ghostPosition, jailPosition):
        ...
        """
        "*** YOUR CODE HERE ***"
        # if ghostPosition == jailPosition and noisyDistance == None: return 1
...
class ExactInference(InferenceModule):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for ghostPosition in self.allPositions:
            ...
            self.beliefs[ghostPosition] = belief * observationProb
        self.beliefs.normalize()
        #raiseNotDefined()
...
class ParticleFilter(InferenceModule):
    ...
    def initializeUniformly(self, gameState):
        ...
        for position in self.legalPositions:
            for _ in range(self.numParticles // numLegal):
...
class JointParticleFilter(ParticleFilter):
    ...
    def initializeUniformly(self, gameState):
        ...
        permutations = itertools.product(ghostPositions, repeat=self.numGhosts)
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for particle in self.particles:
            ...
            for i in range(numGhosts):
                observationProb = self.getObservationProb(observation[i], pacmanPosition, particle[i], self.getJailPosition(i))
